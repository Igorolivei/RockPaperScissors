...
var rockPaperScissors = (function() {
	...
	var play = function(playerChoice) {
	    ...
	    player1Choice = playerChoice ? playerChoice : 
	                     Math.floor(Math.random() * aWeaponsKeys.length);
	...
	var checkPlayerTendencies = function() {
	    for (i in aWeaponsKeys) {
	        var pWeapon = weapons[aWeaponsKeys[i]].counter / iTotalPlays;
	        if (pWeapon >= 0.60) {
...
function checkGameMode() {
    ...
    if (rockPaperScissors.getGameMode() == 1) {
        ...
        gamePvCTitle.innerHTML = rockPaperScissors.getBestOfFive() == true ? "Best of Five: Make your choice!" : 
        						  "Make your choice!";
